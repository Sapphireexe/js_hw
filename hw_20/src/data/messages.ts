...
const REGISTER_MESSAGES: IMessages = {
    successfulRegistration: 'Successfully registered! Please, click Back to return on login page',
    prefixSpaceInLoginError: 'Prefix and postfix spaces are not allowed is username',
    postfixSpaceInLoginError: 'Prefix and postfix spaces are not allowed is username',
    spacesOnlyInLoginError: 'Prefix and postfix spaces are not allowed is username',
    ...
    noLowerCasePasswordError: 'Password should contain at least one character in lower case',
    noUpperCasePasswordError: 'Password should contain at least one character in upper case',
    spacesOnlyInPasswordError: 'Password is required',
    emptyPasswordError: 'Password is required',
    lengthBelowMinimumPasswordError: 'Password should contain at least 8 characters',
...
export {REGISTER_MESSAGES, LOGIN_MESSAGES}